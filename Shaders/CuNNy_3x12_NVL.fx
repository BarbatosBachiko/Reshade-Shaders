...
'--------------------------------------------------------------------------------------------------------|
| Version: 1.0                                                                                           |
| Author: Ported to Reshade by Barbatos, Original Cunny by funnyplanter                                  |
| (https://github.com/funnyplanter/CuNNy)                                                                |
| Magpie content used: https://github.com/Blinue/Magpie/blob/dev/src/Effects/CuNNy2/CuNNy-3x12-NVL.hlsl  |
| License: GNU V3                                                                                        |
'------------------------------------------------------------------------------------------------------*/
#include "ReShade.fxh"

#define RES_W (BUFFER_WIDTH / 2)
#define RES_H (BUFFER_HEIGHT / 2)
#define V3 float3
#define V4 float4
#define M4 float4x4
#define M3x4 float3x4
#define PIXEL_SIZE_HALF (ReShade::PixelSize * 2.0)
#define O(samp, uv, x, y) tex2Dlod(samp, float4((uv) + float2(x, y) * PIXEL_SIZE_HALF, 0, 0))
#define L0_P1(x, y) V3(O(ReShade::BackBuffer, texcoord, x, y).rgb)
#define L0_P2(x, y) V4(O(sT0, texcoord, x, y))
#define L0_P3(x, y) V4(O(sT3, texcoord, x, y))
#define L1_P2(x, y) V4(O(sT1, texcoord, x, y))
#define L2_P2(x, y) V4(O(sT2, texcoord, x, y))
#define L1_P3(x, y) V4(O(sT4, texcoord, x, y))
#define L2_P3(x, y) V4(O(sT5, texcoord, x, y))
#define L0_P4(x, y) V4(O(sT0, texcoord, x, y))
#define L1_P4(x, y) V4(O(sT1, texcoord, x, y))
#define L2_P4(x, y) V4(O(sT2, texcoord, x, y))
#define L0_P5(x, y) V4(O(sT3, coarse_uv, x, y))
#define L1_P5(x, y) V4(O(sT4, coarse_uv, x, y))
#define L2_P5(x, y) V4(O(sT5, coarse_uv, x, y))
...
V4 MulAdd(V3 v, M3x4 m, V4 a)
{
    return mul(v, m) + a;
}
V4 MulAdd(V4 v, M4 m, V4 a)
{
    return mul(v, m) + a;
}

void PS_Pass1(float4 vpos : SV_Position, float2 texcoord : TexCoord, out float4 T0 : SV_Target0, out float4 T1 : SV_Target1, out float4 T2 : SV_Target2)
{
    ...
    s0_0_0 = L0_P1(-1.0, -1.0);
    s0_0_1 = L0_P1(0.0, -1.0);
    s0_0_2 = L0_P1(1.0, -1.0);
    s0_1_0 = L0_P1(-1.0, 0.0);
    s0_1_1 = L0_P1(0.0, 0.0);
    s0_1_2 = L0_P1(1.0, 0.0);
    s0_2_0 = L0_P1(-1.0, 1.0);
    s0_2_1 = L0_P1(0.0, 1.0);
    s0_2_2 = L0_P1(1.0, 1.0);
...
void PS_Pass2(float4 vpos : SV_Position, float2 texcoord : TexCoord, out float4 T3 : SV_Target0, out float4 T4 : SV_Target1, out float4 T5 : SV_Target2)
{
    V4 s0_0_0, s0_0_1, s0_0_2, s0_1_0, s0_1_1, s0_1_2, s0_2_0, s0_2_1, s0_2_2;
    V4 s1_0_0, s1_0_1, s1_0_2, s1_1_0, s1_1_1, s1_1_2, s1_2_0, s1_2_1, s1_2_2;
    V4 r0 = 0.0, r1 = 0.0, r2 = 0.0;

    s0_0_0 = L0_P2(-1.0, -1.0);
    s0_0_1 = L0_P2(0.0, -1.0);
    s0_0_2 = L0_P2(1.0, -1.0);
    s0_1_0 = L0_P2(-1.0, 0.0);
    s0_1_1 = L0_P2(0.0, 0.0);
    s0_1_2 = L0_P2(1.0, 0.0);
    s0_2_0 = L0_P2(-1.0, 1.0);
    s0_2_1 = L0_P2(0.0, 1.0);
    s0_2_2 = L0_P2(1.0, 1.0);
    
    s1_0_0 = L1_P2(-1.0, -1.0);
    s1_0_1 = L1_P2(0.0, -1.0);
    s1_0_2 = L1_P2(1.0, -1.0);
    s1_1_0 = L1_P2(-1.0, 0.0);
    s1_1_1 = L1_P2(0.0, 0.0);
    s1_1_2 = L1_P2(1.0, 0.0);
    s1_2_0 = L1_P2(-1.0, 1.0);
    s1_2_1 = L1_P2(0.0, 1.0);
    s1_2_2 = L1_P2(1.0, 1.0);
    ...
    s0_0_0 = L2_P2(-1.0, -1.0);
    s0_0_1 = L2_P2(0.0, -1.0);
    s0_0_2 = L2_P2(1.0, -1.0);
    s0_1_0 = L2_P2(-1.0, 0.0);
    s0_1_1 = L2_P2(0.0, 0.0);
    s0_1_2 = L2_P2(1.0, 0.0);
    s0_2_0 = L2_P2(-1.0, 1.0);
    s0_2_1 = L2_P2(0.0, 1.0);
    s0_2_2 = L2_P2(1.0, 1.0);
...
void PS_Pass3(float4 vpos : SV_Position, float2 texcoord : TexCoord, out float4 T0 : SV_Target0, out float4 T1 : SV_Target1, out float4 T2 : SV_Target2)
{
    V4 s0_0_0, s0_0_1, s0_0_2, s0_1_0, s0_1_1, s0_1_2, s0_2_0, s0_2_1, s0_2_2;
    V4 s1_0_0, s1_0_1, s1_0_2, s1_1_0, s1_1_1, s1_1_2, s1_2_0, s1_2_1, s1_2_2;
    V4 r0 = 0.0, r1 = 0.0, r2 = 0.0;

    s0_0_0 = L0_P3(-1.0, -1.0);
    s0_0_1 = L0_P3(0.0, -1.0);
    s0_0_2 = L0_P3(1.0, -1.0);
    s0_1_0 = L0_P3(-1.0, 0.0);
    s0_1_1 = L0_P3(0.0, 0.0);
    s0_1_2 = L0_P3(1.0, 0.0);
    s0_2_0 = L0_P3(-1.0, 1.0);
    s0_2_1 = L0_P3(0.0, 1.0);
    s0_2_2 = L0_P3(1.0, 1.0);
    
    s1_0_0 = L1_P3(-1.0, -1.0);
    s1_0_1 = L1_P3(0.0, -1.0);
    s1_0_2 = L1_P3(1.0, -1.0);
    s1_1_0 = L1_P3(-1.0, 0.0);
    s1_1_1 = L1_P3(0.0, 0.0);
    s1_1_2 = L1_P3(1.0, 0.0);
    s1_2_0 = L1_P3(-1.0, 1.0);
    s1_2_1 = L1_P3(0.0, 1.0);
    s1_2_2 = L1_P3(1.0, 1.0);
    ...
    s0_0_0 = L2_P3(-1.0, -1.0);
    s0_0_1 = L2_P3(0.0, -1.0);
    s0_0_2 = L2_P3(1.0, -1.0);
    s0_1_0 = L2_P3(-1.0, 0.0);
    s0_1_1 = L2_P3(0.0, 0.0);
    s0_1_2 = L2_P3(1.0, 0.0);
    s0_2_0 = L2_P3(-1.0, 1.0);
    s0_2_1 = L2_P3(0.0, 1.0);
    s0_2_2 = L2_P3(1.0, 1.0);
...
void PS_Pass4(float4 vpos : SV_Position, float2 texcoord : TexCoord, out float4 T3 : SV_Target0, out float4 T4 : SV_Target1, out float4 T5 : SV_Target2)
{
    V4 s0_0_0, s0_0_1, s0_0_2, s0_1_0, s0_1_1, s0_1_2, s0_2_0, s0_2_1, s0_2_2;
    V4 s1_0_0, s1_0_1, s1_0_2, s1_1_0, s1_1_1, s1_1_2, s1_2_0, s1_2_1, s1_2_2;
    V4 r0 = 0.0, r1 = 0.0, r2 = 0.0;

    s0_0_0 = L0_P4(-1.0, -1.0);
    s0_0_1 = L0_P4(0.0, -1.0);
    s0_0_2 = L0_P4(1.0, -1.0);
    s0_1_0 = L0_P4(-1.0, 0.0);
    s0_1_1 = L0_P4(0.0, 0.0);
    s0_1_2 = L0_P4(1.0, 0.0);
    s0_2_0 = L0_P4(-1.0, 1.0);
    s0_2_1 = L0_P4(0.0, 1.0);
    s0_2_2 = L0_P4(1.0, 1.0);
    
    s1_0_0 = L1_P4(-1.0, -1.0);
    s1_0_1 = L1_P4(0.0, -1.0);
    s1_0_2 = L1_P4(1.0, -1.0);
    s1_1_0 = L1_P4(-1.0, 0.0);
    s1_1_1 = L1_P4(0.0, 0.0);
    s1_1_2 = L1_P4(1.0, 0.0);
    s1_2_0 = L1_P4(-1.0, 1.0);
    s1_2_1 = L1_P4(0.0, 1.0);
    s1_2_2 = L1_P4(1.0, 1.0);
    ...
    s0_0_0 = L2_P4(-1.0, -1.0);
    s0_0_1 = L2_P4(0.0, -1.0);
    s0_0_2 = L2_P4(1.0, -1.0);
    s0_1_0 = L2_P4(-1.0, 0.0);
    s0_1_1 = L2_P4(0.0, 0.0);
    s0_1_2 = L2_P4(1.0, 0.0);
    s0_2_0 = L2_P4(-1.0, 1.0);
    s0_2_1 = L2_P4(0.0, 1.0);
    s0_2_2 = L2_P4(1.0, 1.0);
...
float4 PS_Pass5(float4 vpos : SV_Position, float2 texcoord : TexCoord) : SV_Target
{
    int2 pixel_pos = int2(vpos.xy);
    int2 phase = pixel_pos % 2;
    float2 coarse_uv = texcoord;

    V4 s0_0_0, s0_0_1, s0_0_2, s0_1_0, s0_1_1, s0_1_2, s0_2_0, s0_2_1, s0_2_2;
    V4 s1_0_0, s1_0_1, s1_0_2, s1_1_0, s1_1_1, s1_1_2, s1_2_0, s1_2_1, s1_2_2;
    V4 r0 = 0.0, r1 = 0.0, r2 = 0.0;

    s0_0_0 = L0_P5(-1.0, -1.0);
    s0_0_1 = L0_P5(0.0, -1.0);
    s0_0_2 = L0_P5(1.0, -1.0);
    s0_1_0 = L0_P5(-1.0, 0.0);
    s0_1_1 = L0_P5(0.0, 0.0);
    s0_1_2 = L0_P5(1.0, 0.0);
    s0_2_0 = L0_P5(-1.0, 1.0);
    s0_2_1 = L0_P5(0.0, 1.0);
    s0_2_2 = L0_P5(1.0, 1.0);
    
    s1_0_0 = L1_P5(-1.0, -1.0);
    s1_0_1 = L1_P5(0.0, -1.0);
    s1_0_2 = L1_P5(1.0, -1.0);
    s1_1_0 = L1_P5(-1.0, 0.0);
    s1_1_1 = L1_P5(0.0, 0.0);
    s1_1_2 = L1_P5(1.0, 0.0);
    s1_2_0 = L1_P5(-1.0, 1.0);
    s1_2_1 = L1_P5(0.0, 1.0);
    s1_2_2 = L1_P5(1.0, 1.0);
    ...
    s0_0_0 = L2_P5(-1.0, -1.0);
    s0_0_1 = L2_P5(0.0, -1.0);
    s0_0_2 = L2_P5(1.0, -1.0);
    s0_1_0 = L2_P5(-1.0, 0.0);
    s0_1_1 = L2_P5(0.0, 0.0);
    s0_1_2 = L2_P5(1.0, 0.0);
    s0_2_0 = L2_P5(-1.0, 1.0);
    s0_2_1 = L2_P5(0.0, 1.0);
    s0_2_2 = L2_P5(1.0, 1.0);
    ...
    if (phase.x == 0 && phase.y == 0)
        res = float3(r0.x, r1.x, r2.x);
    else if (phase.x == 1 && phase.y == 0)
        res = float3(r0.y, r1.y, r2.y);
    else if (phase.x == 0 && phase.y == 1)
        res = float3(r0.z, r1.z, r2.z);
    else
        res = float3(r0.w, r1.w, r2.w);

    return float4(saturate(rgb + res), 1.0);
}

technique CuNNy_3x12
{
    pass Pass1
    {
        VertexShader = PostProcessVS;
        PixelShader = PS_Pass1;
        RenderTarget0 = T0_Tex;
        RenderTarget1 = T1_Tex;
        RenderTarget2 = T2_Tex;
    }
    pass Pass2
    {
        VertexShader = PostProcessVS;
        PixelShader = PS_Pass2;
        RenderTarget0 = T3_Tex;
        RenderTarget1 = T4_Tex;
        RenderTarget2 = T5_Tex;
    }
    pass Pass3
    {
        VertexShader = PostProcessVS;
