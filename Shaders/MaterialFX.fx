...
float4 TemplatePS(float4 vpos : SV_Position, float2 texcoord : TexCoord) : SV_Target
{
        ...
        case 3: // Convolution
            {
                float3 kernel[9] =
                {
                    ...
                    float3(-1, 9, -1),
                    float3(-1, -1, -1),
                    float3(0, 0, 0), // Placeholder for the remaining elements
                    float3(0, 0, 0),
                    float3(0, 0, 0),
                    float3(0, 0, 0),
                    float3(0, 0, 0),
...
technique PostProcessMaterials
{
    pass
    {
