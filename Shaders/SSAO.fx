/*
	...
	About:
        Screen-Space Ambient Occlusion (SSAO) using a mix of direction sampling for depth-based occlusion calculations.
	...
	Version 0.6
	+ Add improved random direction version
        * New Ao-Type R2 and RH
*/
